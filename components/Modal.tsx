  ...
  return (
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed drip-shadow-md border border-neutral-700 top-[15%] left-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md: max-w-[450px] translate-x-[-50%] transition-y-[-50%] rounded-md bg-neutral-800 p-[25px] focus:outline-none">
